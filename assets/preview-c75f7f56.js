...
var { document, window: globalWindow } = global, channel = addons.getChannel(), active = false, activeStoryId, handleRequest = async (storyId) => {
  ...
  try {
    ...
    if (!active) {
      ...
      let axe = (await __vitePreload(() => import("./axe-0162f041.js").then((n) => n.a), true ? ["assets/axe-0162f041.js","assets/_commonjsHelpers-ca272635.js"] : void 0)).default, { element = "#storybook-root", config, options = {} } = input, htmlElement = document.querySelector(element);
      if (!htmlElement)
        return;
